<template>
    <div class="flex flex-col w-full h-screen bg-white dark:bg-gray-900">
        <header
            class="w-full bg-white dark:bg-gray-800 shadow-md py-4 fixed top-0 z-50"
        >
            <div
        ...
        <!-- Футер -->
        <footer
            class="py-10 w-full text-blue-950 dark:text-blue-100 bg-gray-200 dark:bg-gray-800 flex items-center justify-center"
        >
            © {{ year }} PoopOk
        </footer>
    </div>
